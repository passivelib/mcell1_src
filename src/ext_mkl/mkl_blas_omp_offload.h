...
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(hgemm)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:A,B,C)
#endif
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(hgemm)) match(construct={target variant dispatch}, device={arch(gen)})
...
#endif
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(gemm_s8u8s32)) match(construct={target variant dispatch}, device={arch(gen)})
...
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(gemm_bf16bf16f32)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:A,B,C)
#endif
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(gemm_bf16bf16f32)) match(construct={target variant dispatch}, device={arch(gen)})
...
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(crot)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:X,Y)
#endif
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(crot)) match(construct={target variant dispatch}, device={arch(gen)})
...
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(zrot)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:X,Y)
#endif
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(zrot)) match(construct={target variant dispatch}, device={arch(gen)})
...
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(hgemm)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:a,b,c)
#endif
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(hgemm)) match(construct={target variant dispatch}, device={arch(gen)})
...
#endif
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(gemm_s8u8s32)) match(construct={target variant dispatch}, device={arch(gen)})
...
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(zrot)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:x,y)
#endif
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(zrot)) match(construct={target variant dispatch}, device={arch(gen)})
...
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(crot)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:x,y)
#endif
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(crot)) match(construct={target variant dispatch}, device={arch(gen)})
