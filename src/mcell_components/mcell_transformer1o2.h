#ifndef _TRANSFORMER_1O2_H_
#define _TRANSFORMER_1O2_H_
...
public:
	...
	Transformer1o2(const char *fileName) : l(NULL), fhl(NULL)
	{
	...
	int FastHenryGenCell(FastHenry *fh, double dp, double ds, double wp, double ws, double s, double sp, double lp, double wtp, double wts, int geometry, string topM, bool fasterCap);
	// ###############################################################################################
	// # transformer1o1
	// # 		: generate cell
	// ###############################################################################################
