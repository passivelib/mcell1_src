...
//************************************************************************************************************************************
// Modification 05.04.2021.
//************************************************************************************************************************************

    //if (name) free_allocation(name);
    //name = NULL;

    for(long unsigned int i=0; i<polygon_array.count; i++)
    {
       	if(polygon_array[i]!=NULL){
        	polygon_array[i]->clear();
        	free_allocation(polygon_array[i]);
        	polygon_array[i]=NULL;
    	}
    ...
    for(long unsigned int i=0; i<reference_array.count; i++)
    {
        if(reference_array[i]!=NULL){
        	reference_array[i]->clear();
        	free_allocation(reference_array[i]);
        	reference_array[i]=NULL;
    	}
    ...
    for(long unsigned int i=0; i<flexpath_array.count; i++)
    {
        
    	if(flexpath_array[i]!=NULL){
        	flexpath_array[i]->clear();
        	free_allocation(flexpath_array[i]);
        	flexpath_array[i]=NULL;
    	}
    ...
    for(long unsigned int i=0; i<robustpath_array.count; i++)
    {
        if(robustpath_array[i]!=NULL){
        	robustpath_array[i]->clear();
        	free_allocation(robustpath_array[i]);
        	robustpath_array[i]=NULL;
    	}
    ...
    for(long unsigned int i=0; i<label_array.count; i++)
    {
        if(label_array[i]!=NULL){
        	label_array[i]->clear();
        	free_allocation(label_array[i]);
        	label_array[i]=NULL;
        }
