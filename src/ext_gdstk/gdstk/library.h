...
//************************************************************************************************************************************
    ...
    void clear() {
        ...
        for(long unsigned int i=0; i<cell_array.count; i++)
        {
            if(cell_array[i]!=NULL){
                cell_array[i]->clear();
                free_allocation(cell_array[i]); //Modification 14.02.2022.
                cell_array[i]=NULL;
            }
        ...
        /*for(long unsigned int i=0; i<rawcell_array.count; i++)
        {
            if(rawcell_array[i]!=NULL){
                rawcell_array[i]->clear();
                rawcell_array[i]=NULL;
            }
